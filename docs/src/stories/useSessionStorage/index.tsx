import { useSessionStorage } from '@vainjs/hooks'
...
export const UseSessionStorage = () => {
  const [key, setKey] = useState<string>('session-key')
  ...
  return (
    <Space direction="vertical" style={{ width: 400 }}>
      <Card title="useSessionStorage 示例">
      ...
      <Typography.Text type="secondary">
        数据会存储在浏览器的 sessionStorage
        中，刷新页面后仍然存在，但关闭标签页后会被清除
      </Typography.Text>
    </Space>
  )
}
