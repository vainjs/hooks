...
const UpdateEffectExample = () => {
  ...
  // 使用 useUpdateEffect，只在更新时执行，跳过首次渲染
  useUpdateEffect(() => {
    const timestamp = new Date().toLocaleTimeString()
    ...
    console.log('Update useEffect executed')
  }, [count])
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div
        ...
        <ul>
          <li>Normal useEffect runs on both mount and updates.</li>
          <li>
            useUpdateEffect only runs on updates, skipping the initial mount.
          </li>
          <li>
            Both effects run asynchronously after the browser paints, unlike
